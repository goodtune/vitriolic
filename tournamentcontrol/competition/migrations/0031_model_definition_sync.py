...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name="seasonreferee",
            options={
                "ordering": ("season", "person__last_name", "person__first_name"),
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                blank=True,
                help_text="The time when the results of the MVP voting will be made public on the website. Leave blank to show at all times.",
                null=True,
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=False,
                help_text="Set this to <b>Yes</b> if this stage should carry over values from the previous stage.",
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.ForeignKey(
                blank=True,
                help_text="When progressing teams into this stage, which earlier stage should be used for determining positions.<br>Default is the immediately preceeding stage.",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=True,
                help_text="Set this to <b>No</b> if this stage does not need to keep a competition ladder.<br>Usually set to No for a Final Series or a Knockout stage.",
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=True,
                help_text="Set this to <b>No</b> if this stage does not need to keep track of MVP points.<br>Usually set to No for a Final Series.",
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=False,
                help_text="In stages with multiple pools, adjust points in the smaller groups to compensate for the reduced opportunity to score points.<br>You <strong>should</strong> also set 0 points for Bye matches.",
            ),
        ),
        migrations.AlterField(
            model_name="stage",
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=False,
                help_text="Set this to <b>Yes</b> if the ladder for this pool should carry over values from the previous stage.<br>Will only apply for matches played against teams that are now in this group.",
                verbose_name="Carry over points",
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=touchtechnology.common.db.models.BooleanField(
                default=False,
                help_text="When the team name is locked, the team manager will not be able to change their team name.<br>As a tournament manager you can always change the names.",
            ),
        ),
        migrations.AlterField(
            model_name="team",
