...
class TestAdminFlow:
    ...
    def test_admin_login(self, page: Page, live_server_url: str, admin_user):
        ...
        expect(page).to_have_url(f"{live_server_url}/admin/")
        expect(page.locator("h1")).to_contain_text("Django administration")

    def test_add_home_page(self, authenticated_page: Page, live_server_url: str):
        """Test adding a home page - must be first thing, literally and nothing else."""
        page = authenticated_page
        
        # Navigate to content/page admin
        page.goto(f"{live_server_url}/admin/common/sitemapnode/add/")
    ...
    def test_add_news_application(self, authenticated_page: Page, live_server_url: str):
    ...
    def test_add_article_to_news(self, authenticated_page: Page, live_server_url: str):
        """Test adding an article to the news application."""
        page = authenticated_page
        
        # Navigate to add article
        page.goto(f"{live_server_url}/admin/news/article/add/")
    ...
    def test_add_competition_application(self, authenticated_page: Page, live_server_url: str):
    ...
    def test_add_competition_structure(self, authenticated_page: Page, live_server_url: str):
        """Test adding competition, season, division, team to the competition application."""
        page = authenticated_page
        
        # Step 1: Add Competition
        page.goto(f"{live_server_url}/admin/competition/competition/add/")
        ...
        # Step 2: Add Season
        page.goto(f"{live_server_url}/admin/competition/season/add/")
        ...
        # Step 3: Add Division
        page.goto(f"{live_server_url}/admin/competition/division/add/")
